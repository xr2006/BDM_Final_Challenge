...
#Step5
results = storeinfo5.mapValues(lambda x: [x[0]]*x[1])\
            .reduceByKey(lambda x,y:x+y)\
            .mapValues(lambda x: round(np.median(np.array(x)),2))\
...
#spark-submit --executor-cores 5 --num-executors 5 --files nyc_supermarkets.csv,nyc_cbg_centroids.csv BDM_Final_sw5034_EC1.py result_EC1
